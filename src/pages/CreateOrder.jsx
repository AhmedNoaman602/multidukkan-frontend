            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <div className={`bg-gray-900 border border-gray-800 rounded-xl p-4 ${user.store_id ? 'col-span-2' : ''}`}>
                        <label className="block text-xs text-gray-400 mb-1.5 uppercase tracking-wider">Customer</label>
                        <CustomerSearchInput
                            customers={customers}
                            value={customerId}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full px-3 py-1.5 bg-gray-800 border border-gray-700 text-white rounded-lg focus:outline-none focus:border-blue-500 text-sm pr-10"
                                        placeholder="0"
                                    />
                                ...
                                {discountType === 'percent' && discountAmount > 0 && (
                                    <p className="text-green-400 text-xs">= {discountAmount} EGP off</p>
                                )}
                            </div>
