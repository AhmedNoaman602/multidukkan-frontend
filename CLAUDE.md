...
- `roleLabels`/`paymentMethodLabels`/`paymentReferenceLabels`/`expenseCategoryLabels` in [src/lib/labels.js](src/lib/labels.js), still imported by `Settings.jsx`, `ReportPrint.jsx`, and `ReverseSupplierPaymentModal.jsx`
